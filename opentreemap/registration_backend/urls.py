...
urlpatterns = [
    ...
    re_path(
        ...
        TemplateView.as_view(
            template_name='registration/activation_complete.html'),  # NOQA
    ...
    re_path(
        r'^register/complete/$',
        TemplateView.as_view(
            template_name='registration/registration_complete.html'),  # NOQA
        name='registration_complete'),
    re_path(
        r'^register/closed/$',
        TemplateView.as_view(
            template_name='registration/registration_closed.html'),  # NOQA

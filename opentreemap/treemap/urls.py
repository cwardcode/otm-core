...
urlpatterns = [
    ...
    re_path(r'^tags/$', routes.tags_list, name="tags_list_view"),
    ...
    re_path(r'^features\/(?P<feature_id>\d+)\/trees\/(?P<tree_id>\d+)\/udf\/(?P<tree_action>[\W\w\s]+)$',
    ...
    re_path('^features/(?P<feature_id>\d+)/photo/(?P<photo_id>\d+)/detail$',
        routes.map_feature_photo_detail, name='map_feature_photo_detail'),
    re_path('^features/(?P<feature_id>\d+)/photo/(?P<photo_id>\d+)$',

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instance', models.ForeignKey(blank=True, to='treemap.Instance', null=True, on_delete=models.CASCADE)),
            ],
        ),
        migrations.CreateModel(
            name='Species',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instance', models.ForeignKey(to='treemap.Instance', on_delete=models.CASCADE)),
                ('species', models.ForeignKey(blank=True, to='treemap.Species', help_text='Species', null=True, on_delete=models.CASCADE)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(to='treemap.UserDefinedFieldDefinition', on_delete=models.CASCADE),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='mapfeaturephoto',
            name='map_feature',
            field=models.ForeignKey(to='treemap.MapFeature', on_delete=models.CASCADE),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(to='treemap.Species', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='itreecodeoverride',
            name='region',
            field=models.ForeignKey(to='treemap.ITreeRegion', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='instanceuser',
            name='role',
            field=models.ForeignKey(to='treemap.Role', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='instanceuser',
            name='user',
        ...
        migrations.AddField(
            model_name='instance',
            name='default_role',
            field=models.ForeignKey(related_name='default_role', to='treemap.Role', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='instance',
            name='eco_benefits_conversion',
            field=models.ForeignKey(blank=True, to='treemap.BenefitCurrencyConversion', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='instance',
            name='users',
        ...
        migrations.AddField(
            model_name='audit',
            name='instance',
            field=models.ForeignKey(blank=True, to='treemap.Instance', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='audit',
            name='ref',
            field=models.ForeignKey(to='treemap.Audit', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='audit',
            name='user',
        ...
        migrations.AddField(
            model_name='tree',
            name='plot',
            field=models.ForeignKey(to='treemap.Plot', on_delete=models.CASCADE),
        ),

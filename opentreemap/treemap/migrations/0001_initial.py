    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Required. 30 characters or fewer. Letters, numbers and @/./+/-/_ characters', unique=True, max_length=30,
                 verbose_name='username', validators=[django.core.validators.RegexValidator(re.compile('^[\\w.@+-]+$'), 'Enter a valid username.', 'invalid')])),
                ...
                ('thumbnail', models.ImageField(
                    null=True, upload_to='users', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(
                    db_index=True, auto_now=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Favorite',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permission_level', models.IntegerField(default=0, choices=[
                 (0, 'None'), (1, 'Read Only'), (2, 'Write with Audit'), (3, 'Write Directly')])),
            ],
        ),
        migrations.CreateModel(
            name='Instance',
            fields=[
                ...
                ('url_name', models.CharField(unique=True, max_length=255, validators=[treemap.instance.reserved_name_validator, django.core.validators.RegexValidator(
                    '^[a-zA-Z]+[a-zA-Z0-9\\-]*$', 'Must start with a letter and may only contain letters, numbers, or dashes ("-")', 'Invalid URL name')])),
                ('basemap_type', models.CharField(default='google', max_length=255, choices=[
                 ('google', 'Google'), ('bing', 'Bing'), ('tms', 'Tile Map Service')])),
                ('basemap_data', models.CharField(
                    max_length=255, null=True, blank=True)),
                ('geo_rev', models.IntegerField(default=1)),
                ('bounds', django.contrib.gis.db.models.fields.MultiPolygonField(srid=3857)),
                ('center_override', django.contrib.gis.db.models.fields.PointField(
                ...
                ('itree_region_default', models.CharField(blank=True, max_length=20, null=True, choices=[(b'TpIntWBOI', b'Temperate Interior West'), (b'NoEastXXX', b'Northeast'), (b'CaNCCoJBK', b'Northern California Coast'), (b'InterWABQ', b'Interior West'), (b'InlEmpCLM', b'Inland Empire'), (b'LoMidWXXX', b'Lower Midwest'), (b'MidWstMSP', b'Midwest'), (
                    b'NMtnPrFNL', b'North'), (b'PacfNWLOG', b'Pacific Northwest'), (b'PiedmtCLT', b'South'), (b'SoCalCSMA', b'Southern California Coast'), (b'GulfCoCHS', b'Coastal Plain'), (b'SWDsrtGDL', b'Southwest Desert'), (b'InlValMOD', b'Inland Valleys'), (b'CenFlaXXX', b'Central Florida'), (b'TropicPacXXX', b'Tropical')])),
        ...
        migrations.CreateModel(
            ...
            bases=(treemap.units.Convertible, treemap.audit.PendingAuditable,
                   treemap.audit.UserTrackable, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID',
                 serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(max_length=255)),
                ('default_permission', models.IntegerField(default=0, choices=[
                 (0, 'None'), (1, 'Read Only'), (2, 'Write with Audit'), (3, 'Write Directly')])),
                ('rep_thresh', models.IntegerField()),
                ('instance', models.ForeignKey(blank=True,
                 to='treemap.Instance', null=True, on_delete=models.CASCADE)),
            ],
        ),
        migrations.CreateModel(
            name='Species',
            ...
            bases=(treemap.audit.PendingAuditable,
                   treemap.audit.UserTrackable, models.Model),
        ),
        migrations.CreateModel(
            name='StaticPage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diameter', models.FloatField(
                    help_text='Tree Diameter', null=True, blank=True)),
                ('height', models.FloatField(
                    help_text='Tree Height', null=True, blank=True)),
                ('canopy_height', models.FloatField(
                    help_text='Canopy Height', null=True, blank=True)),
                ('date_planted', models.DateField(
                    help_text='Date Planted', null=True, blank=True)),
                ('date_removed', models.DateField(
                    help_text='Date Removed', null=True, blank=True)),
                ('instance', models.ForeignKey(
                    to='treemap.Instance', on_delete=models.CASCADE)),
                ('species', models.ForeignKey(blank=True, to='treemap.Species',
                 help_text='Species', null=True, on_delete=models.CASCADE)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='Plot',
            fields=[
                ('mapfeature_ptr', models.OneToOneField(parent_link=True, auto_created=True,
                 primary_key=True, serialize=False, to='treemap.MapFeature', on_delete=models.CASCADE)),
                ('width', models.FloatField(
                    help_text='Plot Width', null=True, blank=True)),
                ('length', models.FloatField(
                    help_text='Plot Length', null=True, blank=True)),
        ...
        migrations.CreateModel(
            name='TreePhoto',
            fields=[
                ('mapfeaturephoto_ptr', models.OneToOneField(parent_link=True, auto_created=True,
                 primary_key=True, serialize=False, to='treemap.MapFeaturePhoto', on_delete=models.CASCADE)),
                ('tree', models.ForeignKey(
                    to='treemap.Tree', on_delete=models.CASCADE)),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                to='treemap.UserDefinedFieldDefinition', on_delete=models.CASCADE),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='map_feature',
            field=models.ForeignKey(
                to='treemap.MapFeature', on_delete=models.CASCADE),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                to='treemap.Species', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='itreecodeoverride',
            name='region',
            field=models.ForeignKey(
                to='treemap.ITreeRegion', on_delete=models.CASCADE),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='default_role',
            field=models.ForeignKey(
                related_name='default_role', to='treemap.Role', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='instance',
            name='eco_benefits_conversion',
            field=models.ForeignKey(
                blank=True, to='treemap.BenefitCurrencyConversion', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='instance',
            name='users',
            field=models.ManyToManyField(
                to=settings.AUTH_USER_MODEL, null=True, through='treemap.InstanceUser', blank=True),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='instance',
            field=models.ForeignKey(
                blank=True, to='treemap.Instance', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='audit',
            name='ref',
            field=models.ForeignKey(
                to='treemap.Audit', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='audit',
            name='user',
        ...
        migrations.AddField(
            ...
            name='plot',
            field=models.ForeignKey(
                to='treemap.Plot', on_delete=models.CASCADE),
        ),
        migrations.AlterUniqueTogether(
            name='species',
            unique_together=set(
                [('instance', 'common_name', 'genus', 'species', 'cultivar', 'other_part_of_name')]),
        ),
        migrations.AlterUniqueTogether(
            name='itreecodeoverride',
        ...
        migrations.AlterUniqueTogether(
            name='fieldpermission',
            unique_together=set(
                [('model_name', 'field_name', 'role', 'instance')]),
        ),
        migrations.AlterUniqueTogether(
            name='favorite',
